...
int lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle(lua_State* tolua_S)
{
    int argc = 0;
    Live2DSprite* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle'", nullptr);
            return 0;
        }
        cobj->setIsAutoIdle();
        lua_settop(tolua_S, 1);
    ...
    {
        bool arg0;
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "Live2DSprite:setIsAutoIdle");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle'", nullptr);
            return 0;
        }
        cobj->setIsAutoIdle(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "Live2DSprite:setIsAutoIdle",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_live2d_Live2DSprite(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Live2DSprite");
        ...
        tolua_function(tolua_S,"setIsAutoIdle", lua_cocos2dx_live2d_Live2DSprite_setIsAutoIdle);
